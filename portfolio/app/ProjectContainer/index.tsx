...
const projects: ProjectData[] = [
  {
    ...
    title: "Rythme & Lasaï",
    tag: "Web",
    description: "Site vitrine créatif pour un duo artistique. Design élégant & animations fluides.",
    index: "01",
  },
  {
    ...
    title: "Yunitto",
    tag: "E-commerce",
    description: "Plateforme moderne avec une expérience utilisateur soignée et des performances optimales.",
    index: "02",
  },
  {
    ...
    tag: "Portfolio",
    description: "Portfolio personnel avec une identité visuelle forte et une navigation intuitive.",
    index: "03",
  },
];
